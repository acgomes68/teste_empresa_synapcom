...
CREATE USER 'db_api'@'localhost' IDENTIFIED BY 'db_api';
GRANT ALL PRIVILEGES ON db_api.* TO 'db_api'@'localhost';
FLUSH PRIVILEGES;
...
CREATE USER 'appCliente'@'localhost' IDENTIFIED BY 'appCliente';
GRANT ALL PRIVILEGES ON app_cliente.* TO 'appCliente'@'localhost';
FLUSH PRIVILEGES;


DROP USER 'gomes'@'localhost';
CREATE USER 'gomes'@'localhost' IDENTIFIED BY 'gomes';
GRANT ALL PRIVILEGES ON *.* TO 'gomes'@'localhost';
FLUSH PRIVILEGES;

DROP USER 'synapcom'@'localhost';
CREATE USER 'synapcom'@'localhost' IDENTIFIED BY 'synapcom';
GRANT ALL PRIVILEGES ON synapcom.* TO 'synapcom'@'localhost';
FLUSH PRIVILEGES;

DROP USER 'veiculos'@'localhost';
CREATE USER 'db_api'@'localhost' IDENTIFIED BY 'db_api';
GRANT ALL PRIVILEGES ON db_api.* TO 'db_api'@'localhost';
FLUSH PRIVILEGES;

CREATE USER 'imoveis'@'localhost' IDENTIFIED BY 'imoveis';
GRANT ALL PRIVILEGES ON imoveis.* TO 'imoveis'@'localhost';
FLUSH PRIVILEGES;
